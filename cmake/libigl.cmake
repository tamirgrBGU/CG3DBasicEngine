...
set(LIBIGL_SOURCE_DIR "${LIBIGL_ROOT}")
...
if(LIBIGL_WITH_COMISO)
  ...
  if(NOT TARGET CoMISo)
    igl_download_comiso()
    add_subdirectory_with_folder("${LIBIGL_EXTERNAL}/CoMISo" "lib" CoMISo)
  endif()
...
if(LIBIGL_WITH_CORK)
  ...
  if(NOT TARGET cork)
    ...
    # "cork" executable
    igl_download_cork()
    add_subdirectory_with_folder("${CORK_DIR}" "lib" "lib-cork")
  endif()
...
if(LIBIGL_WITH_EMBREE)
  ...
  if(NOT TARGET embree)
    ...
    add_subdirectory_with_folder("${EMBREE_DIR}" "lib" "embree" EXCLUDE_FROM_ALL)
  endif()
...
if(LIBIGL_WITH_OPENGL)
  ...
  if(NOT TARGET glad)
    igl_download_glad()
    add_subdirectory_with_folder(${LIBIGL_EXTERNAL}/glad "lib" glad)
  endif()
...
if(LIBIGL_WITH_TETGEN)
  ...
  if(NOT TARGET tetgen)
    igl_download_tetgen()
	add_subdirectory_with_folder(${TETGEN_DIR} "lib" tetgen)	
  endif()
...
if(LIBIGL_WITH_TRIANGLE)
  ...
  if(NOT TARGET triangle)
	...
	add_subdirectory_with_folder(${TRIANGLE_DIR} "lib" triangle)
  endif()
...
if(LIBIGL_WITH_PREDICATES)
  ...
  if(NOT TARGET predicates)
    ...
    add_subdirectory_with_folder("${PREDICATES_DIR}" "lib" "predicates")
  endif()
